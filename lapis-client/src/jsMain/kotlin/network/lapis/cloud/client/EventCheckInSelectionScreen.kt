 ...
 *
 * Die Raumzuordnung lebt seit Welle V1.4.3.x in `EventsScreen.kt` (`renderEventsScreen`), zusammen
 * mit den übrigen Event-Stammdaten -- vorher pragmatisch hier mangels eigenem Anlage-/
 * Bearbeitungs-Screen surfaced (siehe Welle V1.4.3.4).
 */
