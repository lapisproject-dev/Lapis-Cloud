...
/**
 * Welle V1.4.23 "Videokonferenz-Hintergrundeffekte" -- i18n-Waechter. Strukturell identisch zu
 ...
 * `LapisAttributionTest` KDoc). Die Wellendateien liegen bewusst FLACH unter `.../client/`, weil dieser Test
 * das Verzeichnis nach Dateinamen liest (keine Rekursion).
 *
 * Extraktion und Konkatenations-Zusammenfuehrung: siehe [OpenItemI18nCatalogTest] KDoc.
 */
class ConferenceBackgroundI18nCatalogTest :
    FunSpec({
        val clientSrc: File =
