...
intended correction path (receipts are not copied — new line ids — and must be re-uploaded). No
integration with the Übungsleiter-/Ehrenamtspauschale (a separate backlog item; no shared
abstraction is forced until a second instance of the same shape actually exists). The
