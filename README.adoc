...
— the DATEV half is closed as of V1.4.5.2), camt.052/053/054 XML, FinTS/HBCI, splitting one bank
line across multiple contributions, automatic *donation* posting at import time (§25 PartG: a donor
