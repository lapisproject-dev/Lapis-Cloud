...
No self-service UI screen or board queue screen yet (backend/data model only — RPC surface is
complete and tested); no deferral for `IN_DUNNING`/`RETURNED` contributions (would additionally
