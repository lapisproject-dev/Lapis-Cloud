...
matching and a debtor dunning run (V1.4.15, backend/RPC only -- no client screen yet), several bank
...
* **UI coverage has grown substantially since `v0.10.0`, but is still not complete.** Governance,
  ...
  reachable only via Kilua RPC / raw HTTP: payables/receivables including debtor
  dunning (V1.4.15), Compliance (Transparenzregister, §25 PartG, audit log,
